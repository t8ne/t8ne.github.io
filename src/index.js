...
class T8neElement extends LitElement {
  ...
  render() {
    return html`
      ...
      <footer>
        <a class="app-icon" href="http://github.com/t8ne" target="_blank"><img src="../src/assets/footer/github.png" alt="GitHub" width="20" height="20"></a>
        <a class="app-icon" href="http://linkedin.com/in/t8ne/" target="_blank"><img src="../src/assets/footer/linkedin.png" alt="LinkedIn" width="20" height="20"></a>
        <a class="app-icon" href="https://open.spotify.com/user/aantryy" target="_blank"><img src="../src/assets/footer/spotify.png" alt="Spotify" width="20" height="20"></a>
        <a class="app-icon" href="https://www.chess.com/member/t8ne" target="_blank"><img src="../src/assets/footer/pawn.png" alt="Chess" width="20" height="20"></a>
        <a class="app-icon" href="http://youtube.com/@t8n3" target="_blank"><img src="../src/assets/footer/youtube.png" alt="YouTube" width="20" height="20"></a>
        <a class="app-icon" href="https://steamcommunity.com/id/t8ne" target="_blank"><img src="../src/assets/footer/steam.png" alt="Steam" width="20" height="20"></a>
      </footer>
    `;
  }
}
